...
function inserirPais(nomePais, popPais){
    if(encontrarPais() == -1){
        ...
        console.log("[ERRO] você digitou um pais que ja existe na lista")
    }
...
while (opcao) {
    ...
    switch(opcao){
        ...
        case "2":
            ...
            popPais = prompt("Digite a população do país: ")
        ...
        default: console.log("[ERRO] Você digitou uma opção inválida")
